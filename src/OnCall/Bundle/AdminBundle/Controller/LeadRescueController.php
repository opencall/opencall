...
class LeadRescueController extends Controller
{
    ...
    public function indexAction($id)
    {
        ...
        return $this->render(
            'OnCallAdminBundle:LeadRescue:index.html.twig',
            array(
                'hangup_causes' => HangupCause::getFailed(),
                ...
                'campaigns' => $campaigns,
                'sidebar_menu' => MenuHandler::getMenu($role_hash, 'lead_rescue', $this->getClientID(), $params),
