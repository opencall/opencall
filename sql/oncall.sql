...
--
-- Table structure for table `CountFailed`
--

DROP TABLE IF EXISTS `CountFailed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `CountFailed` (
  ...
  `counter` int(12) unsigned NOT NULL,
...
--
-- Dumping data for table `CountFailed`
--

LOCK TABLES `CountFailed` WRITE;
/*!40000 ALTER TABLE `CountFailed` DISABLE KEYS */;
/*!40000 ALTER TABLE `CountFailed` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `CountPLead`
--

DROP TABLE IF EXISTS `CountPLead`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `CountPLead` (
  `date_in` datetime NOT NULL,
  `client_id` int(11) unsigned NOT NULL,
  `campaign_id` int(11) unsigned NOT NULL,
  `adgroup_id` int(11) unsigned NOT NULL,
...
--
-- Dumping data for table `CountPLead`
--

LOCK TABLES `CountPLead` WRITE;
/*!40000 ALTER TABLE `CountPLead` DISABLE KEYS */;
/*!40000 ALTER TABLE `CountPLead` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `CountTotal`
--
...
--
-- Dumping data for table `CountTotal`
--

LOCK TABLES `CountTotal` WRITE;
/*!40000 ALTER TABLE `CountTotal` DISABLE KEYS */;
/*!40000 ALTER TABLE `CountTotal` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-10-03 11:42:45
